...
app.include_router(Books.router, prefix="/api/books", tags=["Books"])      # /api/books, /api/public/books
app.include_router(Carts.router, prefix="/api/carts", tags=["Carts"])
app.include_router(Orders.router, prefix="/api/orders", tags=["Orders"])
app.include_router(Favorites.router, prefix="/api/favorites", tags=["Favorites"])
app.include_router(Reviews.router, prefix="/api/reviews", tags=["Reviews"])  # /api/books/{bookId}/reviews, /api/reviews/...